...
CREATE TYPE app_type AS ENUM ('Uber', 'InDrive', 'Yango');
CREATE TABLE drivers (
    id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    consumer_id BIGINT REFERENCES consumers(id) ON DELETE RESTRICT,
    app app_type NOT NULL,
    years INT NOT NULL,
    trips_per_week INT NOT NULL,
    image_url TEXT
);
...
INSERT INTO home_page_config (id, hero_banner_url, b2b_benefits_url, b2c_benefits_url, faqs, rent_steps)
VALUES (
    1,
    [
        "https://res.cloudinary.com/moba-renting/image/upload/v1755809865/home-page/hero_banner_1.png",
        "https://res.cloudinary.com/moba-renting/image/upload/v1755809866/home-page/hero_banner_2.png"
    ],
    ...
    '[
        {
            "title": "Elige tu taxi",
            "content": "Explora nuestra selección de vehículos disponibles. Filtra por marca, modelo y disponibilidad para encontrar el taxi perfecto para ti."
        },
        {
            "title": "Selecciona el tiempo de renta",
            "content": "Elige tus fechas de alquiler y revisa los detalles, incluyendo precios y requisitos especiales para el período seleccionado."
        },
        {
            "title": "Verifica si estás pre-aprobado",
            "content": "Completa un sencillo formulario con tu información personal, licencia de conducir y preferencias de seguro."
        },
        {
            "title": "Te entregamos el vehículo",
            "content": "Recógelo en nuestra ubicación o recibe el vehículo en tu dirección. Entrega rápida y sin complicaciones."
        }
    ]'::jsonb
);
